...
var totalOccupancyPerDay = {
    ...
    datasets: [{
        ...
        data: [0.998, 0.998, 0.998, 0.998, 0.999, 0.998], 
        backgroundColor: [
            'rgba(53, 44, 36, 0.2)', 
            'rgba(73, 120, 95, 0.2)', 
            'rgba(180, 218, 167, 0.2)', 
...
var totalAvgProdTimePerDay = {
    ...
    datasets: [{
        ...
        data: [58.14, 58.14, 58.14, 58.14, 58.14, 58.14], 
        backgroundColor: [
            'rgba(53, 44, 36, 0.2)',
            'rgba(73, 120, 95, 0.2)', 
            'rgba(180, 218, 167, 0.2)', 
...
var totalAvgDelayPerDay = {
    ...
    datasets: [{
        ...
        data: [249.44, 278.02, 249.53, 398.53, 265.97], 
        backgroundColor: [
            'rgba(53, 44, 36, 0.2)', 
            'rgba(73, 120, 95, 0.2)', 
            'rgba(180, 218, 167, 0.2)', 
...
var totalAccRatePerDay = {
    ...
    datasets: [{
        ...
        data: [0.000001, 0.000001, 0.000001, 0.000001, 0.000001], 
        backgroundColor: [
            'rgba(53, 44, 36, 0.2)', 
            'rgba(73, 120, 95, 0.2)', 
            'rgba(180, 218, 167, 0.2)', 
